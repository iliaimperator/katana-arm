...
@section('title', 'Создание заказ-наряда')

@section('content')
<div class="max-w-6xl">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Создание нового заказ-наряда</h1>

    <form action="{{ route('work-orders.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="reception_date" id="reception_date" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('reception_date', date('Y-m-d')) }}">
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="problem_description" id="problem_description" rows="4" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Опишите проблему, с которой обратился клиент">{{ old('problem_description') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="work_description" id="work_description" rows="3"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Опишите планируемые работы">{{ old('work_description') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="recommendations" id="recommendations" rows="3"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Дополнительные рекомендации клиенту">{{ old('recommendations') }}</textarea>
        ...
        <div class="flex items-center justify-between mt-8 pt-6 border-t">
            <a href="{{ route('work-orders.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded transition duration-200">
                Назад к списку
            </a>
